...
/**
 * HateoasLinks Class Doc Comment
 *
 * @category Class
 * @package  KvK
 * @author   OpenAPI Generator team
 ...
 */
class HateoasLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HateoasLinks';
    ...
    */
    ...
    public function setLinks($links)
    {
        ...
        if ((count($links) > 10)) {
            throw new \InvalidArgumentException('invalid value for $links when calling HateoasLinks., number of items must be less than or equal to 10.');
        }
        if ((count($links) < 1)) {
            throw new \InvalidArgumentException('invalid length for $links when calling HateoasLinks., number of items must be greater than or equal to 1.');
        }

...
/**
 * CommercieleVestiging Class Doc Comment
 *
 * @category Class
 ...
 */
class CommercieleVestiging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommercieleVestiging';
    ...
    */
    ...
    public function setVestigingsnummer($vestigingsnummer)
    {
        ...
        if ((!preg_match("/^[0-9]{12}$/", ObjectSerializer::toString($vestigingsnummer)))) {
            throw new \InvalidArgumentException("invalid value for \$vestigingsnummer when calling CommercieleVestiging., must conform to the pattern /^[0-9]{12}$/.");
        }
